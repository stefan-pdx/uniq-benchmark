...
// https://github.com/bittnkr/uniq/blob/master/js/uniq.js
...
async function consume() {
    console.time("uniq.worker.js");

    for (var messagesReceived = 0; messagesReceived < messageCount; messagesReceived++) {
        await queue.pop();
    }

    console.timeEnd("uniq.worker.js");
}